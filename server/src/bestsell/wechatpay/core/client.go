...
import (
	...
	"bestsell/wechatpay/core/errors"
	"bestsell/wechatpay/core/option"
	"bestsell/wechatpay/core/setting"
...
func (client *Client) SignaturePayInfo(ctx context.Context, params *map[string]interface{}, reply *map[string]interface{}) error {
	return client.credential.GenerateSignaturePayInfo(ctx, params, reply)
}
